...
To send the order, pass ``dry_run=False``, and the response will be populated with a :class:`~tastytrade.order.PlacedOrderResponse`, which contains information about the order and account.
